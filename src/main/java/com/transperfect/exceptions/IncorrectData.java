package com.transperfect.exceptions;
...
public class IncorrectData extends Exception {
     ...
     */
    public IncorrectData(BindingResult result) {
        this.result = result;
    }
     ...
     */
    public IncorrectData(String message, BindingResult result) {
        super(message);
        this.result = result;
    }
     ...
     * @since 1.4
     */
    public IncorrectData(String message, Throwable cause, BindingResult result) {
        super(message, cause);
        this.result = result;
    }
     ...
     * @since 1.4
     */
    public IncorrectData(Throwable cause, BindingResult result) {
        super(cause);
        this.result = result;
    }
